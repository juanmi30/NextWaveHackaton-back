...
52. rootCause.confidence expresses confidence only in the Agent's causal attribution. Never use it to replace, reinterpret, or overwrite the stored detector confidence returned by get_incident.`;
